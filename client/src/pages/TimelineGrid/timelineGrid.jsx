    ...
    return (
      <FullPageContainer>
        <EmptyAlbum>
          ...
          <p>
            Go to the Uploads page to get started, or head to the Albums page to
                ...
                <>
                  ...
                  {state.sortedPhotos[date].map((photo) => {
                    return (
                      <div
                        key={photo.asset_id}
                        onClick={() => handleModalOpen(photo.public_id)}
                      >
      ...
      <div className="button-container">
        {state.next_cursor && !loading ? (
          <Button
            ...
            onClick={(e) => handleLoadMorePhotos(e)}
            type="text"
            style={{ backgroundColor: "#a30101", color: "white" }}
          >
            Load More
          </Button>
        ) : null}
